...
const customTheme = extendTheme({ defaultColorScheme: "dark", colorSchemes: colorSchemes });
        ...
        >
          ...
          >
            <Box sx={{ gap: 2, display: "flex", alignItems: "center" }}>
              <IconButton variant="soft" color="primary" size="sm"></IconButton>
              <Typography level="title-lg">Inwi</Typography>
            </Box>
            <ColorSchemeToggle />
          </Box>
          <Box
